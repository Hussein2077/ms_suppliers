...
import 'package:ms_supplier/minor_screens/edit_store.dart';
import 'package:ms_supplier/models/product_model.dart';
import 'package:ms_supplier/providers/visit_store_controller.dart';
    ...
    return FutureBuilder<DocumentSnapshot>(
      ...
      builder:
        ...
        if (snapshot.hasData && !snapshot.data!.exists) {
          return  Scaffold(
              appBar: AppBar(backgroundColor: AppColor1.backgroundColor,elevation: 0,),
